...
fn add_position() {
    assert_eq!(
        execute("1,5,5,0,99,3").0.memory[0],
        6,
...
fn add_immediate() {
    assert_eq!(
        execute("1101,5,5,0,99,3").0.memory[0],
        10,
...
fn add_mixed() {
    assert_eq!(
        execute("1001,5,5,0,99,3").0.memory[0],
        8,
...
fn add_immediate_output_param() {
    assert_eq!(
        execute("10001,5,5,0,99,3").0.memory[0],
        6,
...
fn mul_position() {
    assert_eq!(
        execute("2,5,5,0,99,3").0.memory[0],
        9,
...
fn mul_immediate() {
    assert_eq!(
        execute("1102,5,5,0,99,3").0.memory[0],
        25,
...
fn mul_mixed() {
    assert_eq!(
        execute("1002,5,5,0,99,3").0.memory[0],
        15,
...
fn mul_immediate_output_param() {
    assert_eq!(
        execute("10002,5,5,0,99,3").0.memory[0],
        9,
...
fn input_nonblocking() {
    assert_eq!(
        run_code(parse_intcode("3,0,99").unwrap(), vec![4]).0.memory[0],
        4,
